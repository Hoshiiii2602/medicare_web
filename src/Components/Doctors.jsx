      ...
      {data ? (
        <>
          <Heading color={"primary.text"} fontWeight={600} textAlign={"center"}>
            {selectedCity
              ? `Bác sĩ giỏi nhất tại ${selectedCity.city}`
              : "Bác sĩ giỏi nhất"}
          </Heading>
          <Text
            fontSize={14}
            ...
            fontWeight={500}
          >
            Đội ngũ bác sĩ chuyên gia của chúng tôi bao gồm nhiều chuyên khoa,
            đảm bảo bạn nhận được sự chăm sóc chất lượng cao nhất phù hợp với
                    ...
                    <Box cursor={"pointer"} padding={5}>
                      ...
                      <Flex justify={"space-between"} mt={1}>
                        ...
                        >
                          ...
                          <Text mt={-0.5}>
                            {item.total_appointment_done} cuộc hẹn đã hoàn thành
                          </Text>
                        </Text>
                      </Flex>
                    </Box>
