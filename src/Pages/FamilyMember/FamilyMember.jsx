...
function FamilyMember() {
  ...
  const vitalsArr = [
    {
      name: "Blood-Pressure",
      icon: <BiDonateHeart fontSize={20} color={theme.colors.blue[600]} />,
      description: "Chi tiết và lịch sử huyết áp",
      box: (
        <BloodPressure
          selectedMember={data}
          startDate={startDate}
    ...
    {
      name: "Blood-Sugar",
      icon: <MdBloodtype fontSize={20} color={theme.colors.blue[600]} />,
      description: "Chỉ số đường huyết và phân tích",
      box: (
        <BloodSugar
          selectedMember={data}
          startDate={startDate}
    ...
    {
      name: "Weight",
      icon: <FaWeight fontSize={20} color={theme.colors.blue[600]} />,
    ...
    {
      name: "Temperature",
      icon: <FaThermometer fontSize={20} color={theme.colors.blue[600]} />,
      description: "Theo dõi nhiệt độ cơ thể.",
      box: (
        <Temperature
          selectedMember={data}
          startDate={startDate}
    ...
    {
      name: "SpO2",
      icon: <SiOxygen fontSize={20} color={theme.colors.blue[600]} />,
      description: "Chỉ số bão hòa oxy trong máu.",
      box: (
                          ...
                          <AccordionPanel p={0} pb={4}>
                            ...
                            >
                              {(() => {
                                switch (member.name) {
                                  case "Blood-Pressure":
                                    return "Chi tiết và lịch sử huyết áp";
                                  case "Blood-Sugar":
                                    return "Chỉ số đường huyết và phân tích";
                                  case "Weight":
                                    return "Theo dõi cân nặng.";
                                  case "Temperature":
                                    return "Theo dõi nhiệt độ cơ thể.";
                                  case "SpO2":
                                    return "Chỉ số bão hòa oxy trong máu.";
                                  default:
