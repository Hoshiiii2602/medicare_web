    ...
    <Modal isOpen={isOpen} onClose={onClose} isCentered>
      ...
      >
        ...
        <ModalBody px={2}>
          ...
          <FormControl mb={4}>
            <FormLabel mb={1}>Huyết áp tâm thu (mmHg)</FormLabel>
            <Input
              type="number"
              placeholder="Nhập huyết áp tâm thu"
              {...register("bp_systolic", { required: true })}
            />
          </FormControl>

          <FormControl mb={4}>
            <FormLabel mb={1}>Huyết áp tâm trương (mmHg)</FormLabel>
            <Input
              type="number"
              placeholder="Nhập huyết áp tâm trương"
      ...
      <AlertDialogOverlay>
        <AlertDialogContent>
          <AlertDialogHeader fontSize="lg" fontWeight="bold">
            Xóa dữ liệu huyết áp
          </AlertDialogHeader>

          <AlertDialogBody fontSize={"md"} fontWeight={500}>
            Bạn có chắc chắn muốn xóa dữ liệu huyết áp ngày - {data?.date}
          </AlertDialogBody>
