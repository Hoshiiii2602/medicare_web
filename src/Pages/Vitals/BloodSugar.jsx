        ...
        <Box p={1} mt={2}>
          ...
          {!data?.length ? (
            <Alert status="error" py={1} fontWeight={600} mt={3} fontSize={14}>
              ...
              {moment(startDate, "YYYY-MM-DD").format("DD MMM YY")} đến{" "}
    ...
    <Modal isOpen={isOpen} onClose={onClose} isCentered>
      ...
      >
        ...
        <ModalBody px={2}>
          ...
          <FormControl mb={4}>
            <FormLabel mb={1}>Đường huyết lúc đói</FormLabel>
            <Input
              type="number"
              placeholder="Nhập đường huyết lúc đói"
              {...register("sugar_fasting", { required: true })}
            />
          </FormControl>

          <FormControl mb={4}>
            <FormLabel mb={1}>Đường huyết ngẫu nhiên</FormLabel>
            <Input
              type="number"
              placeholder="Nhập đường huyết ngẫu nhiên"
    ...
    <Modal isOpen={isOpen} onClose={onClose} isCentered>
      ...
      >
        ...
        <ModalBody px={2}>
          ...
          <FormControl mb={4}>
            <FormLabel mb={1}>Đường huyết lúc đói (Mg/dl)</FormLabel>
            <Input
          ...
          <FormControl mb={4}>
            <FormLabel mb={1}>Đường huyết ngẫu nhiên (Mg/dl)</FormLabel>
            <Input
      ...
      <AlertDialogOverlay>
        <AlertDialogContent>
          ...
          <AlertDialogBody fontSize={"md"} fontWeight={500}>
            Bạn có chắc chắn muốn xóa dữ liệu đường huyết ngày - {data?.date}
          </AlertDialogBody>
